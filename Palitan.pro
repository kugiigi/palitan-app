...
UBUNTU_TRANSLATION_DOMAIN="palitan.kugiigi"
...
aptest.commands = bash $$PWD/palitan/tests/autopilot/run
aptest.depends  = sub-palitan

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/palitan/tests/unit
unittest.depends  = sub-palitan
